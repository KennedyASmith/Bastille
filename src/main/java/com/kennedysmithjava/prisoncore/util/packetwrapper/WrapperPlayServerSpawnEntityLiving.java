...
import com.kennedysmithjava.prisoncore.util.packetwrapper.util.Removed;
...
public class WrapperPlayServerSpawnEntityLiving extends AbstractPacket {
	...
	private static final double MAX_MOT = 3.9D;
	...
	public void setZ(double value) {
		...
		handle.getIntegers().write(4, MathHelper.floor(value * 32.0D));
	}
