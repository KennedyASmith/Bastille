...
public class CmdSkillGiveLevel extends CoreCommand {
    ...
    public void perform() throws MassiveException {
        ...
        mPlayer.getSkillProfile().getSkill(type).setLevel(level, 0);
