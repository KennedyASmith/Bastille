...
public class TreesConf extends Entity<TreesConf> {
    ...
    public static TreesConf get() { return i; }
    ...
    private Map<String, TreeTemplate> treeTemplates = MUtil.map(
            "acacia", new TreeTemplate("acacia", "acacaia_schematic.schematic", 3, 50,
    ...
    public void spawnNewTree(TreeTemplate template, Block block) {
        ...
        spawnSchematic(template.getSchematicName(), block.getLocation().clone().add(-offset.getX(), 0, -offset.getZ()), false);
