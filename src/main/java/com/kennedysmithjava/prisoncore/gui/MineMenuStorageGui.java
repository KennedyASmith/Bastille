...
public class MineMenuStorageGui extends UpgradesGui {
    ...
    public List<GuiButton> getButtons() {
        ...
        GuiOpenerButton tab_1 = new GuiOpenerButton(
                ...
                Material.CHEST,
                new MineMenuStorageTabGui(getPlayer(), StorageType.STORAGE_1, this),
                UpgradeName.STORAGE_1,
                MUtil.list(),
                MUtil.list(new CostCurrency(CurrencyType.CASH, 100)),
                () -> {
                    new ActionBuildingUnlock(BuildingType.CHEST).apply(player);
        ...
        GuiOpenerButton tab_2 = new GuiOpenerButton(
                ...
                "&7[MENU]",
                11,
                MUtil.list("&736 more slots of magic storage!"),
                Material.CHEST,
                new MineMenuStorageTabGui(getPlayer(), StorageType.STORAGE_2, this),
        ...
        GuiOpenerButton tab_3 = new GuiOpenerButton(
                ...
                MUtil.list("&736 more slots of magic storage!"),
                Material.CHEST,
                new MineMenuStorageTabGui(getPlayer(), StorageType.STORAGE_3, this),
        ...
        GuiOpenerButton tab_4 = new GuiOpenerButton(
                ...
                MUtil.list("&736 more slots of magic storage!"),
                Material.CHEST,
                new MineMenuStorageTabGui(getPlayer(), StorageType.STORAGE_4, this),
        ...
        GuiOpenerButton tab_5 = new GuiOpenerButton(
                ...
                MUtil.list("&736 more slots of magic storage!"),
                Material.CHEST,
                new MineMenuStorageTabGui(getPlayer(), StorageType.STORAGE_5, this),
        ...
        GuiOpenerButton tab_6 = new GuiOpenerButton(
                ...
                MUtil.list("&736 more slots of magic storage!"),
                Material.CHEST,
                new MineMenuStorageTabGui(getPlayer(), StorageType.STORAGE_6, this),
        ...
        GuiOpenerButton tab_7 = new GuiOpenerButton(
                ...
                MUtil.list("&736 more slots of magic storage!"),
                Material.CHEST,
                new MineMenuStorageTabGui(getPlayer(), StorageType.STORAGE_7, this),
