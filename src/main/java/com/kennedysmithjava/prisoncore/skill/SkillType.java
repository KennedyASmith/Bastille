...
public enum SkillType {
    ...
    FARMING(Material.IRON_HOE, "&6Farming", MUtil.list("&7Earn &eFarming &7XP by harvesting crops!"), 9+8),
    METALWORKING(Material.ANVIL, "&6Smithing", MUtil.list("&7Earn &eSmithing &7XP by crafting tools!"), 9+9),
    QUESTING(Material.COMPASS, "&6Questing", MUtil.list("&7Earn &eQuesting &7XP by completing quests!"), 9+10),
    ENCHANTING(Material.ENCHANTING_TABLE, "&6Enchanting", MUtil.list("&7Earn &eEnchanting &7XP by enchanting tools!"), 9+11),
    ALCHEMY(Material.POTION, "&6Alchemy", MUtil.list("&7Earn &eAlchemy &7XP by crafting potions!"), 9+12),
